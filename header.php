            ...
            <div class="header-top-row">
                ...
                <div class="header-contact-column">
                    ...
                    <div class="contact-social">
                        ...
                        if ( ! empty( $facebook ) ) : ?>
                            <a href="<?php echo esc_url( $facebook ); ?>" target="_blank" rel="noopener noreferrer" class="social-icon mec-network-facebook" aria-label="<?php esc_attr_e( 'Visit our Facebook page', 'mec_theme' ); ?>">
                        ...
                        if ( ! empty( $twitter ) ) : ?>
                            <a href="<?php echo esc_url( $twitter ); ?>" target="_blank" rel="noopener noreferrer" class="social-icon mec-network-twitter" aria-label="<?php esc_attr_e( 'Visit our Twitter page', 'mec_theme' ); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true" focusable="false">
                        ...
                        if ( ! empty( $instagram ) ) : ?>
                            <a href="<?php echo esc_url( $instagram ); ?>" target="_blank" rel="noopener noreferrer" class="social-icon mec-network-instagram" aria-label="<?php esc_attr_e( 'Visit our Instagram page', 'mec_theme' ); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true" focusable="false">
                        ...
                        if ( ! empty( $linkedin ) ) : ?>
                            <a href="<?php echo esc_url( $linkedin ); ?>" target="_blank" rel="noopener noreferrer" class="social-icon mec-network-linkedin" aria-label="<?php esc_attr_e( 'Visit our LinkedIn page', 'mec_theme' ); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true" focusable="false">
                        ...
                        if ( ! empty( $youtube ) ) : ?>
                            <a href="<?php echo esc_url( $youtube ); ?>" target="_blank" rel="noopener noreferrer" class="social-icon mec-network-youtube" aria-label="<?php esc_attr_e( 'Visit our YouTube channel', 'mec_theme' ); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true" focusable="false">
